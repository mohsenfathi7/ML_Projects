...
class Agent:
    ...
    def save_weights(self):
        #pass
        self.actor_critic.save_weights("/socs/islab_archives/STUDENT_THESIS_dr/POORIA_ISMAILI_MSC_dr/experiments/temp/deep_Q_weights/weights")
        
    def load_weights(self):
        
        if(os.path.isdir('/socs/islab_archives/STUDENT_THESIS_dr/POORIA_ISMAILI_MSC_dr/experiments/temp/deep_Q_weights')):
            self.actor_critic.load_weights("/socs/islab_archives/STUDENT_THESIS_dr/POORIA_ISMAILI_MSC_dr/experiments/temp/deep_Q_weights/weights")
